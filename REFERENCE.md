...
> Last regenerated: 2026-04-23T03:14:10.947Z
...
Total TypeScript/TSX files: **486**
...
| `types.ts` | Command pattern — contracts. | CommandOrigin, Command, DispatchOk, DispatchRejected, +4 |
...
| `ShortcutRegistry.ts` | ShortcutRegistry — single source of truth for every keyboard shortcut in the app. | ShortcutCategory, Shortcut, SHORTCUTS, CATEGORY_LABELS, +1 |
...
| `assemblyTemplateStore.ts` | assemblyTemplateStore — Phase 14.C | useAssemblyTemplateStore, getActiveTemplates |
...
| `clipboardStore.ts` | clipboardStore — Phase 14.P | useClipboardStore |
| `complianceTraceStore.ts` | complianceTraceStore — holds the most recent compliance traces keyed by the entity (pipe or fixture)… | TracedViolation, useComplianceTraceStore, bootComplianceTraceStore |
...
| `multiSelectStore.ts` | multiSelectStore — Phase 14.I | useMultiSelectStore |
...
| `roofingEstimateScopeStore.ts` | roofingEstimateScopeStore — Phase 14.R.6. | EstimateScope, EstimateScopeState, useRoofingEstimateScopeStore, __testables |
| `roofingPdfCalibStore.ts` | roofingPdfCalibStore — Phase 14.R.5. | GroundPoint, PdfCalibMode, PdfCalibState, useRoofingPdfCalibStore |
...
| `roofingSectionDragStore.ts` | roofingSectionDragStore — Phase 14.R.8. | GroundPoint, SectionDragMode, SectionDragState, useRoofingSectionDragStore, +1 |
...
| `multiSelectStore.spec.ts` | multiSelectStore — Phase 14.I tests. | — |
...
| `roofingEstimateScopeStore.spec.ts` | roofingEstimateScopeStore — Phase 14.R.6 tests. | — |
| `roofingPdfCalibStore.spec.ts` | roofingPdfCalibStore — Phase 14.R.5 tests. | — |
...
| `roofingSectionDragStore.spec.ts` | roofingSectionDragStore — Phase 14.R.8 tests. | — |
...
_Generated by `tools/generate-reference.cjs` on 2026-04-23T03:14:11.188Z_
